...
headers = ['Mozilla/5.0 (Windows; U; Windows NT 5.1; pt-BR; rv:1.9.1.11) Gecko/20100701 Firefox/3.5.11 ( .NET CLR 3.5.30729)'
...
def main():
    ...
    db = pymysql.connect(user='root', password='xxxF', host='143.19.42.28', database='vul_store',
                         port=3306)
    cursor = db.cursor()
